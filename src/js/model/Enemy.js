class Enemy extends ExplosiveMesh {
    constructor(_geometry, _material, _cameraSize, _aimbot, _isPursuitCamera, _t) {
        ...
        super(_geometry, _material, new THREE.Vector3(gameParameters.enemy.scale, gameParameters.enemy.scale, gameParameters.enemy.scale), 2);
        ...
        this.lasers = [];
        this.updateSpeed(gameParameters.enemy.speed);
    }
